...
const Header = () => {
  ...
  const navLink: NavLink[] = [
    ...
    { name: "Transções", path: "/transacoes" },
  ];
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
            {isAuthenticated ? (
              ...
              <Link to="/login">
                <LogIn className="bg-primary-500 text-gray-900 font-semibold px-5 py-2.5 rounded-xl flex items-center hover:bg-primary-500 transition-all" />
              </Link>
            )}
          </div>
        ...
        <div>
          <div>
            {isAuthenticated ? (
              ...
              <Link
                to="/login"
                className="bg-primary-500 text-gray-800 font-semibold px-5 py-2.5 rounded-2xl flex items-center justify-center hover:bg-primary-500"
                onClick={() => setIsopen(false)}
              >
                Entrar
              </Link>
